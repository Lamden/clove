...
ETCTESTnetwork = BaseNetwork.get_network_by_symbol('ETH-TESTNET')
...
def test_p2p_transaction_object():
    ...
    assert ETCTESTnetwork.transaction_p2p(sender_address, recipient_address, transaction_value) is not None

def test_p2p_transaction_token_object():
    '''
    Token Transaction Object can be created
    '''
    transaction_value = 0.0
    assert ETCTESTnetwork.transaction_p2p(sender_address, recipient_address, transaction_value, contract_address) is not None

def test_p2p_transaction_token_decimals():
    '''
    ...
    with pytest.raises(ValueError) as error:
        ...
        ETCTESTnetwork.transaction_p2p(sender_address, recipient_address, transaction_value, Zeenus_contract)
    assert str(error.value) == ('Zeenus 💪 token supports at most 0 decimal places.')

def test_p2p_transaction_sender_AssertionError():
    '''
    ...
    with pytest.raises(AssertionError) as error:
        ...
        ETCTESTnetwork.transaction_p2p(bad_sender_address, recipient_address, transaction_value, contract_address)
    assert str(error.value) == ('Provided address is not properly formatted.') 

def test_p2p_transaction_recipient_AssertionError():
    '''
    ...
    with pytest.raises(AssertionError) as error:
        ...
        ETCTESTnetwork.transaction_p2p(sender_address, bad_recipient_address, transaction_value, contract_address)
    assert str(error.value) == ('Provided address is not properly formatted.') 
...
def test_p2p_transaction_value_TypeError():
    ...
    with pytest.raises(TypeError) as error:
        ...
        ETCTESTnetwork.transaction_p2p(sender_address, recipient_address, transaction_value, contract_address)
...
def test_p2p_transaction_contract_TypeError():
    '''
    ...
    with pytest.raises(TypeError) as error:
        ...
        ETCTESTnetwork.transaction_p2p(sender_address, recipient_address, transaction_value, bad_contract_address)
...
'''
def test_p2p_transaction_sign_tx_ETH():
    '''
...
def test_p2p_transaction_token_sign_tx_ETH():
    '''
...
Test creating and signing transaction objects
'''
def test_p2p_transaction_sign_tx_ETH_Testnet():
    '''
...
def test_p2p_transaction_token_sign_tx_ETH_Testnet():
    '''
